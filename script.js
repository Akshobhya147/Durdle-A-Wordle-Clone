...
function refillKeys(){
    for(let i=0;i<done.length;i++)
    {
        if(done[i]==1)
        {
            keys[i].style.backgroundColor="#3A3A3C";
        ...
        {
            keys[i].style.backgroundColor="#B59F3B";
            keys[i].style.color="white";
        }

        else if(done[i]==3)
        {
            keys[i].style.backgroundColor="#538D4E";
            keys[i].style.color="white";
        }
...
if(currentTheme==false)
{
    ...
    while(rows[l]!=currentrow||gameOver==true)
    {
        ...
        for(let child of rows[l].children)
        {
            ...
            console.log("backgroundColor:",child.style.backgroundColor);
        }
        l++;
    }
                ...
                if(res)
                {
                    ...
                    for(let child of currentrow.children)
                    {
                        ...
                        setTimeout(()=>{
                            ...
                            child.children[0].style.color="white";
                            let r1=findKeyIndex(child.children[0]);
                            keys[r1].style.backgroundColor="#538D4E";
                            done[r1]=3;
                    ...
                    for(let child of currentrow.children)
                    {
                        child.style.animation=`finish 0.7s ease-in-out ${c*250}ms 1 none`;
                        c++;
                    }
                    },2000);
    ...
    if(e.keyCode==13){
        ...
        if(currentWord.length<5)
        {
            ...
            if(res)
            {
                ...
                for(let child of currentrow.children)
                {
                    child.style.animation=`finish 0.8s ease-in-out ${c*250}ms 1 none`;
                    c++;
                }
                },2000);
